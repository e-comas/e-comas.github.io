  ...
  <Body title="EXPERIENCE > FIGURES > TESTIMONIALS > BLOGS">
    ...
    <main>
      ...
      <section>
        ...
        <ul>
          <li>We can increase sales by <strong>5 times</strong> within 2 years … Sometimes up to <strong>10 times</strong> in 2 years</li>
        ...
        <ul>
          <li>eCommerce retail sales are forecast to grow to{" "}<strong>$3.4 trillion</strong> by 2025 (Forbes)</li>
          <li>
          ...
          <li>Consumer attention span is a maximum of <strong>8 seconds!</strong>{" "}(ebusinessinstitute.com)</li>
        </ul>
